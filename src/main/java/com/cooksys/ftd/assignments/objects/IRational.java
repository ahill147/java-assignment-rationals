...
interface IRational {
	...
	default IRational add(IRational that) throws IllegalArgumentException {
		...
		int commonDenom = this.getDenominator() * that.getDenominator();
		int num1 = this.getNumerator() * that.getDenominator();
		int num2 = that.getNumerator() * this.getDenominator();
		int sum = num1 + num2;

		return construct(sum, commonDenom);
	}
	...
	default IRational sub(IRational that) throws IllegalArgumentException {
		...
		return construct(result, commonDenom);
	}
